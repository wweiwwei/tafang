...
@ccclass
@menu("UI/UIBMFontLabel")
export default class UIBMFontLabel extends cc.Component {
    ...
    private set multiLanguageKey(v: string) {
    ...
    private setString(v: string) {
        ...
        v.split("").forEach((c) => {
            ...
            sprite.spriteFrame = this.atlas.getSpriteFrame(this.prefix + c);
