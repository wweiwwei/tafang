...
declare type WidgetCallback<T extends IWidget = IWidget> = (
    this: T,
    value: T["value"],
...
declare interface IWidget<TValue = any, TOptions = any> {
    name: string | null;
    value: TValue;
    options?: TOptions;
    type?: widgetTypes;
...
declare interface IButtonWidget extends IWidget<null, {}> {
    type: "button";
}
declare interface IToggleWidget
    extends IWidget<boolean, { on?: string; off?: string }> {
    type: "toggle";
}
declare interface ISliderWidget
    extends IWidget<number, { max: number; min: number }> {
    type: "slider";
}
declare interface INumberWidget extends IWidget<number, { precision: number }> {
    type: "number";
}
declare interface IComboWidget
    extends IWidget<
        string[],
        {
            values:
...
declare interface ITextWidget extends IWidget<string, {}> {
    type: "text";
}

declare interface IContextMenuItem {
    content: string;
...
declare interface IContextMenuOptions {
    callback?: ContextMenuEventListener;
...
declare type ContextMenuItem = IContextMenuItem | null;
declare type ContextMenuEventListener = (
...
declare type SerializedLLink = [number, string, number, number, number, number];
declare class LLink {
    id: number;
    type: string;
    origin_id: number;
...
declare type SerializedLGraphNode<T extends LGraphNode = LGraphNode> = {
    id: T["id"];
    type: T["type"];
    pos: T["pos"];
    size: T["size"];
...
declare type LGraphNodeConstructor<T extends LGraphNode = LGraphNode> = {
    new(): T;
};

declare type SerializedLGraphGroup = {
