...
import { BattleMoveMonsterInfiniteModeFSM } from "./BattleMoveMonsterInfiniteModeFSM";
import { BattleSkillFSM } from "./BattleSkillFSM";

/** 塔防模式防御塔的等待状态机 */
export class BattleWaitMonsterInfiniteModeFSM extends BattleBaseFSM {
    endState(): void {}
    tick(): void {
        this.checkNext();
    }
    ...
    move() {
        ...
        this.fsmManager.switchState(new BattleMoveMonsterInfiniteModeFSM(this.ctx, this.fsmManager));
