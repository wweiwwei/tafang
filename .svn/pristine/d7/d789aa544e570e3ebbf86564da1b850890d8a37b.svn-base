...
export class BattleStateHealing extends BattleBaseState {
    init(): void {}
    ...
    effect() {
        ...
        const h = BattleHeal.createHeal(this.ctx.object, this.target, this.valueCache * this.layer, p);
        this.target.propertyManager.handleHeal(h);
    }
    end(): void {
