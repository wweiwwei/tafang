...
import ListItemRogueEquipment from "../battle/rogue/ListItemRogueEquipment";
import WindowRogueEquipment2 from "../battle/rogue/WindowRogueEquipment2";
import ListItemRogueEquipment2 from "../battle/rogue/WindowRogueEquipment2";
    ...
    refreshUI() {
        ...
        this.refresh.onClick = async () => {
            ...
            if (api) {
                ...
                const itemObtain = api.rogueEquipmentManager().confirmRare();
                if (a.kind === 3) {
                    // 打开新窗口展示
                    await GWindow.open(WindowRogueEquipment2, { id: itemObtain.id });
                }
                this.close();
            }
        };
